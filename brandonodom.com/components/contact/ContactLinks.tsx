...
const circleClass =
  "w-9 h-9 rounded-full bg-sunken border border-line flex items-center justify-center text-ink transition-all transform group-hover:scale-110 mr-3";
...
const ContactLinks = () => {
  ...
  return (
    <div className="flex flex-col space-y-3">
      ...
      >
        <div
          className={`${circleClass} group-hover:border-gmail group-hover:text-gmail`}
        >
          <MailIcon ref={mailRef} size={16} />
        </div>
        <span className={`${labelClass} group-hover:text-gmail`}>
      ...
      >
        <div
          className={`${circleClass} group-hover:border-linkedin group-hover:text-linkedin`}
        >
          <LinkedinIcon ref={linkedinRef} size={16} />
        </div>
        <span className={`${labelClass} group-hover:text-linkedin`}>
          Brandon Odom
        </span>
      </a>
      ...
      >
        <div
          className={`${circleClass} group-hover:border-github group-hover:text-github`}
        >
          <GithubIcon ref={githubWorkRef} size={16} />
        </div>
        <span className={`${labelClass} group-hover:text-github`}>
