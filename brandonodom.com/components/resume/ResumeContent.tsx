    ...
    <>
      ...
      <div className="mb-8">
        ...
        <div className="mb-6 break-inside-avoid">
          ...
          <ul className="text-sm text-gray-600 space-y-1 pl-4 list-disc">
            ...
            <li>
              Building out backend infrastructure to create a long-lasting and
        ...
        <div className="mb-6 break-inside-avoid">
          <div className="flex justify-between items-baseline mb-1">
            ...
            <span className="text-sm text-gray-500">Sept 2019 - Jul 2022</span>
          </div>
          <div className="text-sm font-medium text-gray-600 mb-2">
            Amazon Web Services
          </div>
          <ul className="text-sm text-gray-600 space-y-1 pl-4 list-disc">
            ...
            <li>Upgraded and maintained crucial live service infrastructure</li>
            <li>
              Served as on-call engineer, resolving critical production issues
            </li>
            <li>Authored and maintained internal documentation and runbooks</li>
          </ul>
        </div>
        ...
        <div className="mb-6 break-inside-avoid">
          <div className="flex justify-between items-baseline">
            ...
            <span className="text-sm text-gray-500">Jan 2016 - Dec 2017</span>
          </div>
          <div className="flex justify-between items-baseline mb-1">
            <h4 className="text-base font-medium text-gray-800">
              Student Worker
            </h4>
            <span className="text-sm text-gray-500">May 2014 - Dec 2015</span>
          </div>
          <div className="text-sm font-medium text-gray-600 mb-2">
          ...
          <ul className="text-sm text-gray-600 space-y-1 pl-4 list-disc">
            ...
            <li>
              Assisted in robot modification and maintenance, both hardware and
              software
            </li>
          </ul>
        </div>
        ...
        <div className="mb-6 break-inside-avoid">
          ...
          <ul className="text-sm text-gray-600 space-y-1 pl-4 list-disc">
            ...
            <li>
              Performed routine maintenance and upgrades on all computers on
              campus
            </li>
          </ul>
        </div>
      ...
      <div className="mb-8">
        ...
        <div className="grid sm:grid-cols-2 grid-cols-1 gap-x-8 gap-y-2 break-inside-avoid">
          ...
          <div className="mb-3">
            <h4 className="text-base font-medium text-gray-800 mb-2">Tools</h4>
            <div className="flex flex-wrap">
              <span className="px-2 py-1 bg-gray-100 text-xs rounded-sm mr-2 mb-2">
                LLMs
              </span>
          ...
          <div className="mb-3">
            <h4 className="text-base font-medium text-gray-800 mb-2">Design</h4>
            <div className="flex flex-wrap">
              <span className="px-2 py-1 bg-gray-100 text-xs rounded-sm mr-2 mb-2">
                UI Design
              </span>
      ...
      <div className="mb-8">
        ...
        <div className="mb-6 break-inside-avoid">
          ...
          <ul className="text-sm text-gray-600 space-y-1 pl-4 list-disc">
            ...
            <li>
              Researched under Prof. Cindy Bethel on multiple social robotics
              projects and publications
            </li>
            <li>
              Collaborated with Prof. Chris Archibald on the computational pool
              simulator CueCard
            </li>
          </ul>
        </div>
          ...
          <div className="flex justify-between items-baseline">
            <div>
              ...
              <p className="text-sm text-gray-600">
                ...
                Dinep-Schneider, T. J. Ciufo, Brandon Odom, Zachary Henkel, and
                Cindy L. Bethel. &quot;Therabot™: A Robotic Support
          ...
          <div className="flex justify-between items-baseline">
            <div>
              ...
              <p className="text-sm text-gray-600">
                ...
                integration of the robot operating system with a high-fidelity
                simulator.&quot; In Proceedings of Ground Vehicle Systems
                Engineering and Technology Symposium, p. 378. 2015.
              </p>
            </div>
      ...
      <div>
        ...
        <div className="space-y-2 break-inside-avoid">
          ...
          <div className="flex justify-between">
            <span className="text-sm text-gray-800">
              International Traffic in Arms Regulations (ITAR) Certification
            </span>
